...
mod tests {
    ...
    // Issue: The verify_merkle_proof function has incorrect leaf_index tracking logic
    // for multi-level trees. The current implementation doesn't correctly reconstruct
    // the path from leaf to root for trees with >2 leaves.
    // This is a known limitation that should be fixed before production use.
